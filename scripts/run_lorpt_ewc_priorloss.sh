...
export CLASS_PRIOR_DIR="dataset/prior_real/dog/dog" # prior preserving dataset dir
export CLASS_CAPTION_DIR="dataset/prior_real/dog/caption.txt" # caption of prior preserving dataset dir, e.g.: 
...
for _lora_rank in "${lora_rank[@]}"; do
  ...
  export OUTPUT_DIR="outputs/checkpoints/dog/ewc_reg/prior-loss_lora_rank_${lora_rank}"
  CUDA_VISIBLE_DEVICES=4 python training_scripts/train_lora_w_ti.py \
