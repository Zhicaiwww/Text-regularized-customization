...
def main():
    ...
    for data_dir_name in data_dir_name_list:
        ...
        extra_command = [
            ...
            "--enable_text_reg",
            "--text_reg_loss_weight=0.01",
            "--enable_norm_reg",
            "--enable_ewc_reg",
            "--norm_reg_loss_weight=0", # set to 0 
        ]
        ...
        output_dir = f"{DEBUG_OUTPUT_ROOT if debug else OUTPUT_ROOT}/checkpoints/{data_dir_name}/shareTI_text_0.01_freeze-down/decay_lr_5e-4_gas_4"           
