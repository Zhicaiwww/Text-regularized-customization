...
export CLASS_CAPTION_DIR="dataset/prior_real/samples_dog/caption.txt" # caption of prior preserving dataset dir, e.g.: 
...
# accelerate launch
norm_reg_loss_weights=(0.001 0.01 0.1 1 10 100)
lora_rank=(10)
for _norm_reg_loss_weight in "${norm_reg_loss_weights[@]}"; do
 for _lora_rank in "${lora_rank[@]}"; do
    ...
    export OUTPUT_DIR="outputs/checkpoints/dog/ewc_reg/ewc_real_weight_${norm_reg_loss_weight}_rank_${lora_rank}"
