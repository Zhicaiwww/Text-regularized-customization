...
def main():
    ...
    for data_dir_name in data_dir_name_list:
        ...
        output_dir = f"{DEBUG_OUTPUT_ROOT if debug else OUTPUT_ROOT}/checkpoints/{data_dir_name}/shareTI_text_0.01_G-ewc_0.01/decay_lr_5e-4_gas_4"
